...
const RippleButton: React.FC<RippleButtonProps> = ({
  ...
  if (variant === 'hover') {
    const hoverButtonFinalClassName = [
      "relative", "rounded-lg", "text-sm", "px-4", "py-2",
  ...
  if (variant === 'hoverborder') {
    const hoverBorderButtonFinalClassName = [
      "relative", "rounded-lg", "overflow-hidden", "text-sm", "px-4", "py-2",
  ...
  // Default variant
  const baseClasses = "relative border-none overflow-hidden isolate transition-all duration-200 cursor-pointer px-4 py-2 bg-primary hover:opacity-90 text-primary-foreground rounded-lg";
